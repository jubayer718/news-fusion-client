...
export const routes = createBrowserRouter([
  {
    ...
    children: [
      ...
      , {
        ...
        loader:({params})=>fetch(`https://newsfusion-server.vercel.app/recent/details/${params.id}`)
      }
    ]
  }, {
    path: "/userDashboard",
    ...
    children: [
      ...
      },
      {
        ...
        loader:({params})=>fetch(`https://newsfusion-server.vercel.app/singleAdmin/${params.id}`)
      }
    ]
  }
])