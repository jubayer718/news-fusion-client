...
const Dashboard = () => {
  return (
    <div className="flex flex-col lg:flex-row gap-5 w-11/12 mx-auto">
      <div>
        <ul className="menu text-black bg-orange-400 min-h-screen  w-56">
  <li className="menu-title text-black">Admin </li>
  ...
  <li><NavLink to='/dashboard/allArticles'>All Articles</NavLink></li>
          ...
          <li><NavLink to='/dashboard/adminProfile'>AdminProfile</NavLink></li>
